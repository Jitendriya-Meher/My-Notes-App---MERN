  ...
  return (
    <div className='flex w-11/12 max-w-[1160px] py-12 mx-auto gap-x-12 gap-y-0 justify-between'>
        ...
        <div className="w-11/12 max-w-[570px]">
            ...
            A note-taking site developed using the MERN stack—MongoDB, Express.js, React, and Node.js—offers a robust and efficient platform for users to organize and manage their notes in a dynamic and responsive environment. The MongoDB database provides a scalable and flexible structure for storing notes, allowing for seamless expansion as users create and accumulate content. Express.js serves as the backend framework, facilitating the creation of a secure and performant API that connects the frontend and the database.
            <br />
            <br />
